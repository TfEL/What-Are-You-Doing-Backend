  ...
  <body>
    ...
    <div style="max-width: 350px; margin-left:auto; margin-right:auto;">
        ...
        <form action="login_format.php" method="post">
            <p><strong>Email Address:</strong><input type="email" name="emailaddress" placeholder="firstname.lastname123@schools.sa.edu.au" class="form-control" required="required"><small>This will be your @schools.sa.edu.au or @sa.gov.au email.</small></p>
            <p><strong>Password:</strong><input type="password" name="password" placeholder="password123" class="form-control" required="required"><small>We don't have a crazy password requirement, so no symbols required here!</small></p>
            <p class="text-center"><a href="/forgot.php" class="btn btn-warning btn-lg"><span class="glyphicon glyphicon-asterisk"></span> Forgot Password</a> <button type="submit" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-ok"></span> Log In</button><div class="clearfix"></div></p>
        </form>
    </div>
